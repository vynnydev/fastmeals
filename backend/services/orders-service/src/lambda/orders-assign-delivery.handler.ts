...
import { HttpDeliveryClient } from '../infrastructure/clients/http-delivery.client';
...
const deliveryClient = new HttpDeliveryClient(process.env.DELIVERY_SERVICE_URL || 'http://delivery-service:3004');
