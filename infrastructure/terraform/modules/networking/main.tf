# ============================================
# FastMeals — Networking Module
# VPC + Public/Private Subnets + NAT + SGs
# ============================================
...
# --- Private Subnets (2 AZs for RDS, ElastiCache, MQ) ---
...
resource "aws_security_group" "mq" {
  ...
  ingress {
    ...
    protocol        = "tcp"
    security_groups = [aws_security_group.lambda.id]
    description     = "HTTPS Management from Lambda"
  }
