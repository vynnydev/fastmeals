...
const defaultContent: Record<EmptyStateType, { title: string; description: string }> = {
  orders: {
    ...
    description: 'Os pedidos aparecerao aqui assim que forem criados.',
  },
  products: {
    title: 'Nenhum produto cadastrado',
    description: 'Comece adicionando produtos ao seu cardapio.',
  },
  delivery: {
  ...
  reports: {
    ...
    description: 'Os relatorios aparecerao quando houver dados disponiveis.',
  },
  search: {
  ...
  generic: {
    ...
    description: 'Nao ha dados disponiveis no momento.',
  },
}
